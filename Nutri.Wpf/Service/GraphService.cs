...
public class GraphService
{
    public SeriesCollection CalorieDistributionPiChart(params FoodProcuct[] foodProcuct)
    {
        ...
        var carbohydratesCalories = foodProcuct.ToList().Sum(x => x.Nutrients.FirstOrDefault(x => x.Name == "Carbohydrate, by difference")!.Amount * 4);
    ...
    public SeriesCollection CalorieDistributionPiChart(params FoodPortion[] foodProcuct)
    {
        ...
        var carbohydratesCalories = foodProcuct.ToList().Sum(x => x.FoodProduct.Nutrients.First(x => x.Name == "Carbohydrate, by difference").Amount * 4);
